...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp  13.65 //19.00
  #define DEFAULT_Ki  0.80  // 1.34
  #define DEFAULT_Kd  58.26 //67.50
  // MakerGear
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 47.82 //40.68
  #define DEFAULT_bedKi 9.04  //7.93
  #define DEFAULT_bedKd 168.66 //139.15
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
